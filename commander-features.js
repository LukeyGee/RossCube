...
function createManaDistributionChart(deck) {
    ...
    const html = `
    <div style="text-align: center; margin: 30px 0; style="width: 100%; overflow: hidden;">
        <div id="${chartId}" style="width: 170px; height: 170px; border-radius: 50%; position: relative; margin: 0 auto; border: 3px solid #FFD700; background: #333; overflow: hidden; float: left;">
        </div>
        <div style="margin-left: 190px; font-size: 14px; color: #CCCCCC;">
            ${segments.map(s => `
